...
import devices from '../../../project-name-device-gallery/src/components/devices-mock-data';
import DeviceCard from '../../../project-name-device-gallery/src/components/DeviceCard';
